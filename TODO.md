...
- [x] Cunado se ejecuta endFlow y luego tiene un capture:true queda esperando la respuesta
...
- [x] cunado escribes a whatsapp al contacto el bot tmb responde (globalArg con boolean)
...
- [x] ubuntu venom node 18.19 (→ Node 22 LTS)
- [x] ubuntu venom node 20.10 (→ Node 22 LTS)
- [x] ubuntu venom node 21.7.2 (→ Node 22 LTS)

- [ ] win venom node 18.19 (PENDIENTE: sin SO Windows)
- [ ] win venom node 20.10 (PENDIENTE: sin SO Windows)
- [ ] win venom node 21.7.2 --> pnpm probar (PENDIENTE: sin SO Windows)
...
- [x] espera que se genere el qr code validar controler si no consige la imagn
- [x] meta avisa connecto cunado no tiene webhook
- [x] aviso node node 20.12.1 npm v10.5.0 o superior de lo contrario sharp
- [x] Error: ENOENT: no such file or directory, open './node_modules/venom-bot/dist/utils/spinnies.js'
- [x] coverage
- [x] test meta
- [x] try catch error http
- [x] test twilio
- [x] meta recuerda activar los dos webhooks
- [x] cambiar el CONTRIBUTING.md
