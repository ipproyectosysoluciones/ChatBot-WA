                        ...
                        ? e.map(([e, o]) => [
                              ...
                              o.map((e) =>
                                  'string' == typeof e
                                      ? r + e
                                      : 'object' == typeof e
                                        ? Object.fromEntries(Object.entries(e).map(([e, o]) => [r + e, o]))
                                        : e
                              ),
                          ])
                        : e,
            ...
            const B = ((e, ...r) => {
                            ...
                            (s = (o = {
                                ...
                                parseClassName: ((e) => {
                                    const { separator: r, experimentalParseClassName: o } = e,
                                        ...
                                        s = (e) => {
                                            ...
                                            const d = 0 === s.length ? e : e.substring(i),
                                                c = d.startsWith('!'),
                                                p = c ? d.substring(1) : d
                                            return {
                                                modifiers: s,
                                ...
                                ...((e) => {
                                    const r = ((e) => {
                                            ...
                                            return (
                                                i(Object.entries(e.classGroups), o).forEach(([e, o]) => {
                                                    l(o, t, e, r)
                                                }),
                                                t
                                            )
                ...
                return {
                    ...
                    classGroups: {
                        ...
                        'max-w': [
                            { 'max-w': [P, r, 'none', 'full', 'min', 'max', 'fit', 'prose', { screen: [N] }, N] },
                        ],
                        ...
                        leading: [{ leading: ['none', 'tight', 'snug', 'normal', 'relaxed', 'loose', k, P] }],
                        ...
                        'text-decoration-thickness': [{ decoration: ['auto', 'from-font', k, z] }],
                        ...
                        'bg-image': [
                            { bg: ['none', { 'gradient-to': ['t', 'tr', 'r', 'br', 'b', 'bl', 'l', 'tl'] }, _] },
                        ],
                        'bg-color': [{ bg: [e] }],
