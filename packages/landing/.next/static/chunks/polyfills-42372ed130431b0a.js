!(() => {
    ...
    var r,
        ...
        O = Object,
        x = b(''.split),
        R = a(() => !O('z').propertyIsEnumerable(0)) ? (t) => ('String' === E(t) ? x(t, '') : O(t)) : O,
        P = (t) => null == t,
        A = TypeError,
        j = (t) => {
        ...
        T = void 0 === I && void 0 !== I ? (t) => 'function' == typeof t || t === I : (t) => 'function' == typeof t,
    ...
    var W = n,
        ...
        Ot = !u && !a(() => 7 !== Object.defineProperty(Et('div'), 'a', { get: () => 7 }).a),
        ...
        Pt = u && a(() => 42 !== Object.defineProperty(() => {}, 'prototype', { value: 42, writable: !1 }).prototype),
        At = String,
        jt = TypeError,
        kt = (t) => {
            if (M(t)) return t
    ...
    var Ve =
            ...
            ((t, e) => {
                var r
                return (
                    null === t ? (r = Ge()) : ((He[ze] = kt(t)), (r = new He()), (He[ze] = null), (r[qe] = t)),
                    void 0 === e ? r : Be.f(r, e)
                )
            }),
        Ye = Ct.f,
    ...
    ;(ao in uo ||
        ...
        dt('hasInstance'))
    var so = (t, e, r) => (r.get && oe(r.get, e, { getter: !0 }), r.set && oe(r.set, e, { setter: !0 }), Ct.f(t, e, r)),
        co = zt.EXISTS,
    ...
    var ci = (t, e, r) => {
        ...
        pi = b(li.entries),
        vi = pi(new fi()).next,
        di = (t, e, r) => (r ? ci({ iterator: pi(t), next: vi }, (t) => e(t[1], t[0])) : hi(t, e))
    Ce(
        { target: 'Map', proto: !0, real: !0, forced: !0 },
        {
            every: function (t) {
    ...
    ;((Yi.prototype = Hi),
        ...
        Ce({ target: 'Number', stat: !0, nonConfigurable: !0, nonWritable: !0 }, { EPSILON: 2 ** -52 }))
    var Xi = i.isFinite
    Ce({ target: 'Number', stat: !0 }, { isFinite: Number.isFinite || ((t) => 'number' == typeof t && Xi(t)) })
    var Ji = Math.floor,
        Qi = Number.isInteger || ((t) => !M(t) && isFinite(t) && Ji(t) === t)
    ;(Ce({ target: 'Number', stat: !0 }, { isInteger: Qi }),
        Ce({ target: 'Number', stat: !0 }, { isNaN: (t) => t != t }))
    var Zi = Math.abs
    ;(Ce({ target: 'Number', stat: !0 }, { isSafeInteger: (t) => Qi(t) && Zi(t) <= 9007199254740991 }),
        Ce(
    ...
    var wa = Object.is || ((t, e) => (t === e ? 0 !== t || 1 / t == 1 / e : t != t && e != e))
    Ce({ target: 'Object', stat: !0 }, { is: wa })
    var Sa = ya.values
    ;(Ce({ target: 'Object', stat: !0 }, { values: (t) => Sa(t) }), Ce({ target: 'Object', stat: !0 }, { hasOwn: ut }))
    ...
    Ce({ target: 'Reflect', stat: !0, forced: Pa }, { apply: (t, e, r) => Ra(J(t), e, kt(r)) })
    var Aa = Function,
        ja = b([].concat),
        ka = b([].join),
        Ia = {},
    ...
    ;(Ce(
        ...
        Ce({ target: 'Reflect', stat: !0, sham: !u }, { getOwnPropertyDescriptor: (t, e) => Rt.f(kt(t), e) }),
        Ce({ target: 'Reflect', stat: !0, sham: !Vr }, { getPrototypeOf: (t) => Qr(kt(t)) }),
        Ce({ target: 'Reflect', stat: !0 }, { has: (t, e) => e in t }),
        Ce({ target: 'Reflect', stat: !0 }, { isExtensible: (t) => (kt(t), So(t)) }),
    ...
    var ts = dt('match'),
        es = (t) => {
            var e
            return M(t) && (void 0 === (e = t[ts]) ? 'RegExp' === E(t) : !!e)
        },
        rs = function () {
            var t = kt(this),
                e = ''
    ...
    var _s = zt.PROPER,
        ...
        Bs = RegExp.prototype,
        Ds = Bs[Fs]
    ;(a(() => '/a/b' !== Ds.call({ source: 'a', flags: 'b' })) || (_s && Ds.name !== Fs)) &&
        ie(
            Bs,
            Fs,
            function () {
    ...
    var Tf = (t) => {
        ...
        Nf = (t) => ({ size: t, has: () => !1, keys: () => ({ next: () => ({ done: !0 }) }) }),
        Cf = (t) => {
            var e = L('Set')
            try {
                new e()[t](Nf(0))
    ...
    var hl = dt('species'),
        ...
        gl = !(
            ...
            (W >= 51 ||
                !a(() => {
                    var t = []
                    return (((t.constructor = {})[hl] = () => ({ foo: 1 })), 1 !== t.concat(Boolean).foo)
                }))
        )
    Ce(
            ...
            for (
                ...
                switch (((o = n[f]), c)) {
                    ...
                    case vg:
                        ...
                        if (':' !== o || p) {
                            if (o === Wv || '/' === o || '?' === o || '#' === o || ('\\' === o && this.isSpecial())) {
    ...
    var Ky,
        ...
        em = Ue('Promise', () => {
            ...
            if (!W || W < 51 || !/native code/.test(t)) {
                ...
                if ((((r.constructor = {})[Qy] = n), !(Zy = r.then(() => {}) instanceof n))) return !0
            }
    ...
    if (Vm)
        var Ym = [
            ...
            Xm = ArrayBuffer.isView || ((t) => t && Ym.indexOf(Object.prototype.toString.call(t)) > -1)
    function Jm(t) {
