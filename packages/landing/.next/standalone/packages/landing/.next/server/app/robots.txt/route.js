;(() => {
            ...
            2276: (a, b, c) => {
                ...
                async function w() {
                    const a = await {
                        ...
                        b = (0, v.resolveRouteData)(a, 'robots')
                    return new u.NextResponse(b, {
                        headers: {
                ...
                const x = new e.AppRouteRouteModule({
                        definition: {
                        ...
                        relativeProjectDir: '',
                        resolvedPagePath:
                            'next-metadata-route-loader?filePath=%2Fmedia%2Fbladimir%2FDatos2%2FDatos%2Fproyectos%2Fwork%2FChatBot-WA%2Fpackages%2Flanding%2Fsrc%2Fapp%2Frobots.ts&isDynamicRouteExtension=1!?__next_metadata_route__',
                ...
                async function C(a, b, c) {
                    var d
                    let e = '/robots.txt/route'
                    '/index' === e && (e = '/')
                    const g = await x.prepare(a, b, { srcPage: e, multiZoneDraftMode: !1 })
                    if (!g)
                        return (
                            (b.statusCode = 400),
                            b.end('Bad Request'),
                    ...
                    try {
                        const d = async (c) =>
                            ...
                            g = async (g) => {
                                var i, j
                                const k = async ({ previousCacheEntry: f }) => {
                                        try {
                                            ...
                                            if (!F)
                                                return (await (0, o.I)(N, O, e, M.renderOpts.pendingWaitUntil), null)
                                            {
                                ...
                                const m = (0, p.fromNodeOutgoingHttpHeaders)(l.value.headers)
                                return (
    ...
    b.C(a)
    var c = b.X(0, [998, 123], () => b((b.s = 2276)))
    module.exports = c
})()
